    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<img src=\"BannerCRL.jpg\" alt=\"Imagen de la CRL\" width=\"1300\" height=\"350\">\n"
                    ...
                    + "		<h1>\n"
                    + "			\n"
                    + "				Bienvenido " + user.getUsuario() + " a la pagina oficial de la crl \n"
                    + "			\n"
                    + "       <br>"
                    + "Ahora podras ver los resultados de tu equipo preferido       </h1>"
                    
                    + "<h1> Usuario: " + user.getUsuario() + "</h1>");
            out.println("<h1> Correo Electronico: " + user.getCorreo() + "</h1>");
            out.println("<h1> Password: " + user.getContra() + "</h1>");
            out.println("<h1> Fecha de nacimiento: " + user.getFNam() + "</h1>");
